...
// Please follow this link for implementing opentelemetry https://opentelemetry.io/docs/instrumentation/js/instrumentation/

const allClaim = async (req: Request, res: Response) => {
